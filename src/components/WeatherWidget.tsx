...
export const WeatherWidget: React.FC<WeatherWidgetProps> = ({ onWeatherUpdate }) => {
  ...
  return (
    <div className={`bg-gradient-to-br rounded-[32px] p-8 border shadow-2xl relative overflow-hidden group flex flex-col justify-center transition-all duration-500 ${
