    ...
    <div className="min-h-screen bg-white text-neutral-900 font-sans selection:bg-emerald-100 selection:text-emerald-900">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          >
            <motion.div 
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-emerald-50 text-emerald-700 text-[11px] font-black uppercase tracking-[0.25em] mb-10 border border-emerald-100/50"
            >
      ...
      <section className="py-40 px-6 bg-[#0F0F0F] text-white overflow-hidden relative">
        ...
        <div className="max-w-7xl mx-auto relative z-10 text-center">
          ...
          >
            <h2 className="text-4xl sm:text-6xl md:text-[10rem] font-display uppercase tracking-tighter leading-tight mb-8 md:mb-12">
              Protect My <br />
