...
export const Dashboard: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const mockAlerts: any[] = [
      {
        id: 'a1',
        title: 'Weather Alert',
        message: 'Heavy rain expected in Mangalagiri. Coverage automatically activated.',
        type: 'weather',
    ...
    const filtered = mockAlerts.filter(a => currentLocation.toLowerCase().includes(a.location.toLowerCase()));
    setAlerts(filtered);
